        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <SectionCard title="Project Information">
            <div className="space-y-4">
              {/* EGQ ID — auto-generated by backend */}
              <div>
                <label className="block text-sm font-medium mb-1">EGQ ID</label>
                <div className="px-3 py-2 rounded-lg border border-border-light bg-gray-50 text-sm text-text-secondary" data-testid="egq-id-placeholder">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setNonMspo({ ...nonMspo, projectStartDate: e.target.value })}
                          data-testid="input-project-start-date"
                        />
                      </div>
                      <div>
                        <label className="block text-xs font-medium text-text-secondary mb-1">Go Live Date</label>
                        <input
                          type="date"
                          className="input-field"
                          value={nonMspo.projectGoLiveDate}
                          onChange={(e) => setNonMspo({ ...nonMspo, projectGoLiveDate: e.target.value })}
          ...
          <SectionCard title="Technical Information">
            <p className="text-sm text-text-secondary italic">No fields configured for this section.</p>
          </SectionCard>

          {/* Section 5: Data Information */}
          <SectionCard title="Data Information">
            <p className="text-sm text-text-secondary italic">No fields configured for this section.</p>
          </SectionCard>
