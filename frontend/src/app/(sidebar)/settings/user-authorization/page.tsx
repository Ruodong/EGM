...
const ROLE_COLORS: Record<string, string> = {
  ...
  governance_lead: 'bg-blue-100 text-blue-700',
  domain_reviewer: 'bg-purple-100 text-purple-700',
                ...
                roles.map((r) => (
                  <tr key={r.id} className="border-b border-border-light last:border-0 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2">
                      <span className={clsx('px-2 py-0.5 rounded text-xs', ROLE_COLORS[r.role] || 'bg-gray-100 text-gray-600')}>
